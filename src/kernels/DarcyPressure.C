...
registerMooseObject("adabaApp", DarcyPressure);
...
DarcyPressure::validParams()
{
  ...
  // Add a required parameter. if this isn't provided in the input file MOOSE will give error
  ...
  params.addParam<Real>("viscosity", 7.98e-04, "The dynamic viscoity ($\\mu$) of the fluid, the default value is that of water at 30"
